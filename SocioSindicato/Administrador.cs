...
using SocioSindicato.ViewsAdministrador;
using System;
...
namespace SocioSindicato
{
    public partial class Administrador : Form
    {
        ...
        //BOTON AGREGAR SOCIO
        private void btAgregarSoc_Click(object sender, EventArgs e)
        {
            activate_Button(sender, RGBColors.color1);
            Agrega_soc(new ViewsAdministrador.AgregarSocio());
        ...
        //BOTON BUSCAR SOCIO
        private void btBuscarSoc_Click(object sender, EventArgs e)
        {
        ...
        //BOTON EDITAR SOCIO
        private void btEditarSoc_Click(object sender, EventArgs e)
        {
            activate_Button(sender, RGBColors.color3);
            Agrega_soc(new ViewsAdministrador.EditarSocio());
        ...
        private void btEliminarSoc_Click(object sender, EventArgs e)
        {
            activate_Button(sender, RGBColors.color4);
            Agrega_soc(new ViewsAdministrador.EliminarSocio());
